...
from ldm.data.open_images import COCOEEDataset, OpenImageDataset, reverse_image_tensor, reverse_mask_tensor, reverse_clip_tensor
import time
...
def main():
    ...
    outdir = opt.outdir
    if opt.scale > 1:
        outdir = opt.outdir + f'_guidance{opt.scale}'
        ...
        with precision_scope("cuda"):
            with model.ema_scope():
                for index, batch in enumerate(dataloader):
                    ...
                    # if os.path.exists(os.path.join(grid_dir, name_prefix + '.jpg')):
                    #     continue
                    ...
                    grid_img  = [res_dict['bg'][0], x_border, res_dict['fg'][0], x_border, res_dict['comp'][0]]
